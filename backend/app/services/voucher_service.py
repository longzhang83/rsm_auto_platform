    ...
    async def generate_vouchers(
        ...
        try:
            ...
            if employee_file:
                ...
                employee_df = self._read_excel_with_fallback(employee_bytes, header=0, dtype=str)
                ...
                default_config = VoucherConfig(
                    ...
                    employee_file="人员列表.xlsx"
                )
                print(f"尝试加载默认员工文件: {default_config.data_dir / default_config.employee_file}")
        ...
        voucher_category_value = voucher_category or self.settings.default_voucher_category
